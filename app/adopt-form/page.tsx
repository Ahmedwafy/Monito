        ...
        <div className="bg-white dark:bg-(--color-neutral-0)! rounded-3xl shadow-2xl overflow-hidden">
          ...
          >
            ...
            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-(--color-primary-darkBlue) dark:text-(--color-neutral-100) border-b border-(--color-secondary-monYellow)/30 pb-3">
                Personal Information
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full rounded-xl border-2 px-4 py-3 dark:bg-(--color-neutral-10) dark:text-(--color-neutral-100) focus:outline-none ${errors.fullName ? "border-red-500 focus:border-red-500" : "border-gray-200 dark:border-gray-700 focus:border-(--color-secondary-monYellow)"}`}
                  />
                  {errors.fullName && (
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-xl border-2 px-4 py-3 dark:bg-(--color-neutral-10) dark:text-(--color-neutral-100) focus:outline-none ${errors.phone ? "border-red-500 focus:border-red-500" : "border-gray-200 dark:border-gray-700 focus:border-(--color-secondary-monYellow)"}`}
                  />
                  {errors.phone && (
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-xl border-2 px-4 py-3 dark:bg-(--color-neutral-10) dark:text-(--color-neutral-100) focus:outline-none ${errors.email ? "border-red-500 focus:border-red-500" : "border-gray-200 dark:border-gray-700 focus:border-(--color-secondary-monYellow)"}`}
                  />
                  {errors.email && (
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={3}
                    className={`w-full rounded-xl border-2 px-4 py-3 dark:bg-(--color-neutral-10) dark:text-(--color-neutral-100) focus:outline-none ${errors.address ? "border-red-500 focus:border-red-500" : "border-gray-200 dark:border-gray-700 focus:border-(--color-secondary-monYellow)"}`}
                  />
                  {errors.address && (
                    <p className="mt-2 text-sm text-red-600">
                      {errors.address}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full rounded-xl border-2 border-gray-200 dark:border-gray-700 dark:bg-(--color-neutral-0) dark:text-(--color-neutral-100) px-4 py-3 focus:border-(--color-secondary-monYellow)"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-xl border-2 px-4 py-3 dark:bg-(--color-neutral-0) dark:text-(--color-neutral-100) focus:outline-none ${errors.householdMembers ? "border-red-500 focus:border-red-500" : "border-gray-200 dark:border-gray-700 focus:border-(--color-secondary-monYellow)"}`}
                  />
                ...
                {formData.hasChildren === "yes" && (
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      className={`w-full rounded-xl border-2 px-4 py-3 dark:bg-(--color-neutral-0) dark:text-(--color-neutral-100) focus:outline-none ${errors.childrenAges ? "border-red-500 focus:border-red-500" : "border-gray-200 dark:border-gray-700 focus:border-(--color-secondary-monYellow)"}`}
                    />
                    {errors.childrenAges && (
                      <p className="mt-2 text-sm text-red-600">
                        {errors.childrenAges}
                ...
                {formData.hasOtherPets === "yes" && (
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      className={`w-full rounded-xl border-2 px-4 py-3 dark:bg-(--color-neutral-0) dark:text-(--color-neutral-100) focus:outline-none ${errors.otherPetsDetails ? "border-red-500 focus:border-red-500" : "border-gray-200 dark:border-gray-700 focus:border-(--color-secondary-monYellow)"}`}
                    />
                ...
                {formData.previousExperience === "yes" && (
                  <div className="md:col-span-2">
                    ...
                    <textarea
                      ...
                      className={`w-full rounded-xl border-2 px-4 py-3 dark:bg-(--color-neutral-0) dark:text-(--color-neutral-100) focus:outline-none ${errors.experienceDetails ? "border-red-500 focus:border-red-500" : "border-gray-200 dark:border-gray-700 focus:border-(--color-secondary-monYellow)"}`}
                    />
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full rounded-xl border-2 px-4 py-3 dark:bg-(--color-neutral-10) dark:text-(--color-neutral-100) focus:outline-none ${errors.reasonForAdoption ? "border-red-500 focus:border-red-500" : "border-gray-200 dark:border-gray-700 focus:border-(--color-secondary-monYellow)"}`}
                  />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full rounded-xl border-2 px-4 py-3 dark:bg-(--color-neutral-10) dark:text-(--color-neutral-100) focus:outline-none ${errors.availability ? "border-red-500 focus:border-red-500" : "border-gray-200 dark:border-gray-700 focus:border-(--color-secondary-monYellow)"}`}
                  />
                  {errors.availability && (
                    <p className="mt-2 text-sm text-red-600">
                      {errors.availability}
            ...
            <div className="space-y-4 bg-(--color-secondary-monYellow)/5 dark:bg-(--color-neutral-10) p-6 rounded-2xl">
              <h3 className="text-xl font-semibold text-(--color-primary-darkBlue) dark:text-(--color-neutral-100) mb-4">
                Commitments
              </h3>
            ...
            <div className="pt-6">
              <Button
                ...
                className="group flex items-center justify-center w-full mx-auto max-w-xs hover:max-w-[350px] py-5 text-xl bg-(--color-primary-darkBlue)
                  hover:bg-(--color-primary-darkBlue) dark:text-(--color-neutral-100)! dark:bg-(--color-neutral-0)! dark:hover:bg-(--color-card-bg)! 
