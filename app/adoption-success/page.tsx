    ...
    <div className="min-h-screen bg-(--color-secondary-monYellow-40)! dark:bg-(--color-neutral-0)! flex items-center justify-center px-4 py-16 my-2 mx-2 rounded-2xl">
      <div className="bg-white dark:bg-(--color-neutral-5)! rounded-3xl shadow-2xl p-8 md:p-12 lg:p-16 max-w-3xl w-full text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-(--color-primary-darkBlue) dark:text-(--color-neutral-100) mb-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 md:gap-6 mb-10">
            <Link href="/">
              <Button
                variant="primary"
                className="text-lg px-10 py-4 dark:text-(--color-neutral-100)! dark:bg-(--color-primary-darkBlue) dark:hover:bg-white dark:hover:text-(--color-primary-darkBlue)!"
              >
                return to Home
              </Button>
            </Link>
            ...
            <Link href="/available-pets">
              <Button
                ...
                className="text-lg px-10 py-4 border-(--color-primary-darkBlue) text-(--color-primary-darkBlue) dark:border-(--color-secondary-monYellow)
                 dark:text-(--color-secondary-monYellow) dark:hover:bg-(--color-secondary-monYellow) dark:hover:text-(--color-neutral-0)"
              >
                explore more pets
              </Button>
            </Link>
