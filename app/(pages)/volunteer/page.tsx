      ...
      <section className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {volunteerOpportunities.map((opp, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl shadow-xl p-6 md:p-8 hover:shadow-2xl transition-all duration-300 flex flex-col"
            >
              ...
              <p className="text-gray-700 mb-4 flex-1">{opp.description}</p>
