        ...
        <div className="bg-white dark:bg-(--color-neutral-0) rounded-2xl shadow-xl p-6 md:p-10 border border-transparent dark:border-(--color-card-border)">
          ...
          <div className="prose prose-lg text-gray-800 dark:text-gray-300 max-w-none">
            ...
            <p>
              ...
              the right to decline any application if we believe it&apos;s not
            ...
            <p>
              All content on this site (photos, text, design) is owned by One
              More Friend or used with permission. You may not reproduce or
