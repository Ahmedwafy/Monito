    ...
    <section className="mx-4 lg:mx-0 ">
      <div className="bg-(--color-secondary-monYellow-40) dark:bg-(--color-neutral-0) dark:border dark:border-(--color-neutral-10) rounded-2xl px-4 py-10 lg:py-16 max-w-[99%] mx-auto mb-2">
        <footer className="container mx-auto ">
          <div className="flex flex-col sm:flex-row gap-2 justify-between px-8 bg-(--color-primary-darkBlue) dark:bg-(--color-neutral-10) w-full mx-auto rounded-2xl pb-4 sm:p-0 pt-2 lg:p-4">
            <h4 className="text-(--color-neutral-0) dark:text-(--color-neutral-60) tracking-tight md:tracking-normal text-xl md:text-2xl my-auto sm:w-1/3 flex justify-center sm:justify-start p-2">
